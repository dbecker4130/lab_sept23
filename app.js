...
function multiplyArray(testArray){ //eslint-disable-line
  var firstArrayProduct = multiply(testArray [0], testArray [1])[0];
  var secondArrayProduct = multiply(firstArrayProduct, testArray[2])[0];

  var message = 'The numbers ' + testArray + ' have a product of 24.';
  var output = [secondArrayProduct, message];
  console.log(output);
  return output;
}
